...
import example.chatea.servicecamera.alarm.AlarmHelper;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button autoRecording = (Button) findViewById(R.id.auto_recording_button);
        autoRecording.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
